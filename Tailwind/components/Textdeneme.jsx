...
import { Text, TextInput, View, Image, Pressable, TouchableHighlight } from "react-native"
...
export const Textdeneme = ({navigation}) => {
    ...
    return(
        ...
        navigation.navigate('SingUp')} className="mt-8 w-80 h-10 items-center justify-center rounded-md bg-blue-500">
